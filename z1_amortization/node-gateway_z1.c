...
/* Z1: Reassembly buffer sized for POLY_DEGREE=32 max auth payload (~590 bytes).
 * Layout: 1(type) + 13(syndrome) + 128(pubkey) + 256(S[2]) + 128(w) + 32(commit) + 32(kw) */
static uint8_t reassembly_buf[640];
