/**
 * cooja_logger_bp.js
 * Comprehensive Metrics Logger - Base Paper Parameter Version
 * Kumari et al. (POLY_DEGREE=512, RING_SIZE=3, Amortization enabled)
 *
 * Logs to: basepaper_amortization/simulation_result.log
 *
 * Metrics captured:
...
var logPath = "/home/selfi/contiki-ng/examples/Amortization_Research/basepaper_amortization/simulation_result.log";
 ...
 * ===================================================================== */
out.write("==============================================================\n");
out.write("   BASE PAPER PARAMETER AMORTIZATION - SIMULATION METRICS    \n");
out.write("   Kumari et al. | n=512 | N=3 | LDPC 102x204 | AEAD         \n");
out.write("==============================================================\n");
...
function writeFinalSummary() {
    ...
    out.write("\n[G] DATA PHASE (Amortized AES-CTR + HMAC-SHA256)\n");
    ...
    out.write("Variant,n,N,KeyGen_ms,Auth_ms,Verify_ms,DataLatency_ms,AuthPayload_B,Renewals\n");
    out.write("BasePaper_Amortized," + 512 + "," + 3 + "," +
        keygen_ms.toFixed(3) + "," + auth_ms.toFixed(3) + "," +
        verify_ms.toFixed(3) + "," + e2e_latency.toFixed(3) + "," +
        total_auth_bytes + "," + m.renewal_count + "\n");
    out.write("==============================================================\n");
