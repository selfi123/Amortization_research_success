 ...
 * *** BASE PAPER PARAMETER VERSION (Kumari et al.) ***
 *
 ...
 *
 * IMPORTANT: This version requires Cooja Mote (JVM, unlimited RAM).
 * Do NOT compile for Z1 (8KB RAM) - use z1_amortization/ for that.
 *
 * Implements:
 * - Ring-LWE with polynomial degree 512
 * - Ring signatures for anonymous authentication (N=3 members)
 * - QC-LDPC encoding/decoding for hybrid encryption
 * - Session amortization with AEAD (OUR NOVEL CONTRIBUTION)
 */
